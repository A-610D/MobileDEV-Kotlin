package ru.andreyfisher.netologyvoiceassistantf
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initViews()
        //Log.d(TAG, "before initWolframEngine()")
        initWolframEngine()
        //Log.d(TAG, "after initWolframEngine()")
        initTts()
    }
    ...
    fun initViews() {
        ...
        requestInput.setOnEditorActionListener { v, actionId, event ->
            ...
            // клавиатура будет спрятана
            return@setOnEditorActionListener false
        }

        // список в интерфейсе для pods
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            kotlin.runCatching {
                ...
                withContext(Dispatchers.Main) {
                    progressBar.visibility = View.GONE
                    // обработать ошибку
                    // показать Snackbar с текстом ошибки либо с общим текстом согласно локализации
